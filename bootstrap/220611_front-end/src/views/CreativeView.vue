      ...
      <div class="container-fluid p-0">
        <div class="row g-0">
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="assets/creative/img/portfolio/fullsize/1.jpg"
              title="Project Name"
            >
              <img
                class="img-fluid"
                src="../assets/creative/img/portfolio/thumbnails/1.jpg"
                alt="..."
              />
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            >
              <img
                class="img-fluid"
                src="../assets/creative/img/portfolio/thumbnails/2.jpg"
                alt="..."
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            >
              <img
                class="img-fluid"
                src="../assets/creative/img/portfolio/thumbnails/3.jpg"
                alt="..."
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            >
              <img
                class="img-fluid"
                src="../assets/creative/img/portfolio/thumbnails/4.jpg"
                alt="..."
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            >
              <img
                class="img-fluid"
                src="../assets/creative/img/portfolio/thumbnails/5.jpg"
                alt="..."
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            >
              <img
                class="img-fluid"
                src="../assets/creative/img/portfolio/thumbnails/6.jpg"
                alt="..."
              />
